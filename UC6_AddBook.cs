...
namespace Day10Assignment_AddressBook
{
    class UC6_AddBook
    {
        ...
        public static List<UC6_AddBook> ContactDetail = new List<UC6_AddBook>();
        public Dictionary<string, UC6_AddBook> AddBook;
        public static void AddBook6()
        {
            UC6_AddBook person = new UC6_AddBook();
